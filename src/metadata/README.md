 ...
 * [aao.yml](aao.yml)
     * Determines how your purl.obolibrary.org/obo/aao/ redirects will be handled
     ...
     * Paste in the contents of [aao.yml](aao.yml)
 ...
 * [aao.md](aao.md)
     ...
     * Paste in the contents of [aao.md](aao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
